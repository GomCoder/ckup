...
<div id="bo_list" class="sub_inner form_inner">
  <div class="form_wrap">
        ...
        <div class="contain_box">
            ...
            <div class="guide_box2">
                <div class="box">
                    <div class="info_box">
                        <p>
                            시장조사를 원하시는 분께서는 "시장조사 신청하기" 버튼 클릭 후 필요한 내용 기재 후 하단의 "제출하기"를 클릭해주세요.<br>
                            <b>아이템 수가 복수인 경우에는 "복수아이템 엑셀등록" 을 클릭해주세요.</b><br>
                            조사 완료 후 이메일로 결과를 전달드립니다.
                         </p>
                    </div>
                    <div class="btn_box">
                        <a href="<?php echo $write_href ?>" class="main_btn"><i class="fas fa-edit"></i> 시장조사 신청하기</a>
                        <a class="sub_btn2" href="">복수아이템 엑셀등록</a>
                    </div>
                </div>
            </div>
                    ...
                    <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>  <?php if ($is_category && $list[$i]['ca_name']) { ?>li_cate<?php } ?>">
                        ...
                        <div class="bo_subject_box">
                            ...
                            <a href="<?php echo $list[$i]['href'] ?>" class="bo_subject">
                                <p><?php echo $list[$i]['subject'] ?> / <?php echo $list[$i]['wr_1'] ?> 결제대행 신청입니다.</p>
                                <div class="bo_info">
