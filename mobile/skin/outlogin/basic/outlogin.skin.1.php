...
<section id="ol_before" class="ol">
    ...
    <fieldset>
        <div class="ol_wr">
            ...
            <input type="text" id="ol_id" class="input_txt" name="mb_id" required maxlength="20" placeholder="아이디">
            <label for="ol_pw" id="ol_pwlabel" class="sound_only">비밀번호<strong>필수</strong></label>
            <input type="password" name="mb_password" id="ol_pw" class="input_txt" required maxlength="20" placeholder="비밀번호">
